...
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/c1K.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/Aku.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/Aku.jpg'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002573533031 -1002598224860 -1002406402473  -1002640068354').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002619708020'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002583774600'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002495480179'))  
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://snowie2122:snowie@filetolink.7imij.mongodb.net/?retryWrites=true&w=majority&appName=Filetolink")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://ansh:ansh2122@cluster0.ik1o5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CineChefMovies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CineChefMoviesUpdates')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ANSHtheGENIOUS')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/filtergroupupdates')

AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-100'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-100'))

IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002600592361'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002600592361'))
VERIFY_IMG = environ.get("VERIFY_IMG", "https://envs.sh/c17.jpg")
